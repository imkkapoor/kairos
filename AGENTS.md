...
Guidance for Codex (and any AI agent) working in this repository. Read this first; it explains what Kairos is, where the load-bearing pieces live, and the conventions that, if violated, will silently break trading logic.
